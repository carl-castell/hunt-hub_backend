...
\restrict pOiex59RwDpuSvWXmyC8L1Ln6i2ma2Ts8Z7sYNgvSCOFbYV02sSMlybnUIxQfo1
...
CREATE TABLE public.accounts (
    ...
    CONSTRAINT active_requires_password CHECK (((active = false) OR (password IS NOT NULL)))
);
...
--
-- Name: contacts; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.contacts OWNER TO app;
...
--
-- Name: session; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.session OWNER TO app;
...
--
-- Name: templates; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.templates OWNER TO app;

--
-- Name: templates_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Name: contacts contacts_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: session session_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: templates templates_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: IDX_session_expire; Type: INDEX; Schema: public; Owner: app
--
...
--
-- Name: areas areas_estate_id_estates_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.areas
    ADD CONSTRAINT areas_estate_id_estates_id_fk FOREIGN KEY (estate_id) REFERENCES public.estates(id) ON DELETE CASCADE;
...
--
-- Name: contacts contacts_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--
...
ALTER TABLE ONLY public.drive_stand_assignments
    ADD CONSTRAINT drive_stand_assignments_drive_group_id_drive_groups_id_fk FOREIGN KEY (drive_group_id) REFERENCES public.drive_groups(id) ON DELETE SET NULL;


--
-- Name: drive_stand_assignments drive_stand_assignments_drive_id_drives_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.drive_stand_assignments
    ADD CONSTRAINT drive_stand_assignments_drive_id_drives_id_fk FOREIGN KEY (drive_id) REFERENCES public.drives(id) ON DELETE CASCADE;
...
--
-- Name: events events_estate_id_estates_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.events
    ADD CONSTRAINT events_estate_id_estates_id_fk FOREIGN KEY (estate_id) REFERENCES public.estates(id) ON DELETE CASCADE;
...
--
-- Name: hunting_licenses hunting_licenses_estate_id_estates_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.hunting_licenses
    ADD CONSTRAINT hunting_licenses_estate_id_estates_id_fk FOREIGN KEY (estate_id) REFERENCES public.estates(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT invitations_event_id_events_id_fk FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT invitations_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: template_groups template_groups_template_id_templates_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.template_groups
    ADD CONSTRAINT template_groups_template_id_templates_id_fk FOREIGN KEY (template_id) REFERENCES public.templates(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.template_stand_assignments
    ADD CONSTRAINT template_stand_assignments_template_group_id_template_groups_id FOREIGN KEY (template_group_id) REFERENCES public.template_groups(id) ON DELETE SET NULL;


--
-- Name: template_stand_assignments template_stand_assignments_template_id_templates_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.template_stand_assignments
    ADD CONSTRAINT template_stand_assignments_template_id_templates_id_fk FOREIGN KEY (template_id) REFERENCES public.templates(id) ON DELETE CASCADE;


--
-- Name: templates templates_estate_id_estates_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.templates
    ADD CONSTRAINT templates_estate_id_estates_id_fk FOREIGN KEY (estate_id) REFERENCES public.estates(id) ON DELETE CASCADE;
...
--
-- Name: training_certificates training_certificates_estate_id_estates_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.training_certificates
    ADD CONSTRAINT training_certificates_estate_id_estates_id_fk FOREIGN KEY (estate_id) REFERENCES public.estates(id) ON DELETE CASCADE;
...
\unrestrict pOiex59RwDpuSvWXmyC8L1Ln6i2ma2Ts8Z7sYNgvSCOFbYV02sSMlybnUIxQfo1
